...
//    private static final int KEY_HEIGHT = 10;
//    private static final int NOTE_WIDTH = 16; // Width of a beat
//    private static final int BEATS_PER_MEASURE = 1;
//    private static final int MEASURE_WIDTH = 128;   //NOTE_WIDTH * BEATS_PER_MEASURE; // Width of a measure
//    private static final int RESIZE_MARGIN = 5;
//    private static final int MIN_MIDI_PITCH = 21; // A0 MIDI pitch
//    private static final int MAX_MIDI_PITCH = 108; // C8 MIDI pitch
//    private List<Note> notes;
...
//                gc.fillText("M" + measure, i + 2, 10);
//                measure++;
//            } else if (i % NOTE_WIDTH == 0) { // New beat
//                gc.setStroke(Color.LIGHTGRAY);
//                gc.strokeLine(i, 0, i, getHeight());
//            }
//        }
...
//    private static final int KEY_HEIGHT = 10;
//    private static final int NOTE_WIDTH = 40; // Width of a beat
...
//        Note clickedNote = getNoteAt(x, y);
//
//        if (event.getButton() == MouseButton.SECONDARY) {  // Use getButton() for clarity
//            if (clickedNote != null) {
//                notes.remove(clickedNote);
//                updateTrack();
//                drawNotes();
//            }
//            event.consume();  // Consume the event to prevent other handlers from processing it
//        } else {
//            if (clickedNote == null) {
//                addNoteAt(x, y);
//            }
...
//        new Thread(() -> {
//            try {
//                midiChannel.noteOn(pitch, 64); // Note on with velocity 64
//                Thread.sleep(500); // Play for 500 milliseconds
//                midiChannel.noteOff(pitch); // Note off
//            } catch (InterruptedException e) {
//                e.printStackTrace();
//            }
//        }).start();
